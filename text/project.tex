...
\begin{figure}[H]
\centering
\includegraphics[width=10cm,height=10cm]{../cumulative_variance_graysalce.pdf} 
\caption{Cumulative variance explainde by the components regarding the grayscale features}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=10cm,height=10cm]{../cumulative_variance_grb.pdf} 
\caption{Cumulative variance explainde by the components regarding the rgb features}
\end{figure}
\noindent As the plost above show, in both cases, using 150 is enough to explain all the variance in the data. To compare and analyze the performance of the learning algorithms i choose to use the following set of principal components $\{3,10,50,100,150\}$


\begin{figure}[H]  
  \begin{adjustwidth}{-4cm}{-4cm}
     \subfloat{%
       \includegraphics[scale=0.4]{../knn_accuracy_grayscale.pdf}
     }
     \subfloat{%
    \includegraphics[scale=0.4]{../knn_accuracy_rgb.pdf}  
     }
     \centering
     \caption{Training performances knn}
      \end{adjustwidth}
   \end{figure}
